...
public class SpriteSheet
{
    ...
    public void Draw(SpriteBatch spriteBatch, Vector2 position, Vector2 origin,Color color) //extended this to allow color
    {
    ...
    {
        Draw(spriteBatch,position,origin,Color.White);
    }
